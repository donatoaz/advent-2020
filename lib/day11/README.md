...
My solution does not seem to be approved by AoC site, but it also does not seem to be incorrect...

I'm giving up on trying to find a so called "problem" with my solution, but if you do spot an error, please let me know,
I'll buy you a proverbial beer.
